...
```gradle
dependencies {
    implementation 'com.github.apiverve:taxidvalidator-api:1.1.13'
}
```
...
```java
import com.apiverve.taxidvalidator.TaxIDValidatorAPIClient;
import com.apiverve.taxidvalidator.APIResponse;
import com.apiverve.taxidvalidator.APIException;

// Initialize the client
TaxIDValidatorAPIClient client = new TaxIDValidatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("taxid", "123-45-6789");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/taxidvalidator](https://docs.apiverve.com/ref/taxidvalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/taxidvalidator](https://docs.apiverve.com/ref/taxidvalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/taxidvalidator-api/issues)
