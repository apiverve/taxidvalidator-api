...
namespace APIVerve.API.TaxIDValidator
{
    ...
    /// <summary>
    /// Client for the TaxIDValidator API
    /// </summary>
    public class TaxIDValidatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/taxidvalidator";
        ...
        {
            { "taxid", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public TaxIDValidatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TaxIDValidatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TaxIDValidatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TaxIDValidatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TaxIDValidatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(TaxIDValidatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TaxIDValidatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TaxIDValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TaxIDValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TaxIDValidatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TaxIDValidatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TaxIDValidatorQueryOptions options)
        {
