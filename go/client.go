...
const (
	baseURL        = "https://api.apiverve.com/v1/taxidvalidator"
	defaultTimeout = 30 * time.Second
)

// Client is the Tax ID Validator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Tax ID Validator API client.
...
// Execute makes a request to the Tax ID Validator API with typed parameters.
//
