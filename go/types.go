// Package taxidvalidator provides a Go client for the Tax ID Validator API.
//
// For more information, visit: https://apiverve.com/marketplace/taxidvalidator?utm_source=go&utm_medium=readme
package taxidvalidator
...
// Request contains the parameters for the Tax ID Validator API.
//
// Parameters:
//   - taxid (required): string - The US Tax ID to validate (SSN, EIN, or ITIN format)
type Request struct {
...
// ResponseData contains the data returned by the Tax ID Validator API.
type ResponseData struct {
	...
	ValidationDetails ValidationDetailsData `json:"validation_details"`
	Error interface{} `json:"error"`
}

// ValidationDetailsData represents the validation_details object.
type ValidationDetailsData struct {
	FormatValid bool `json:"format_valid"`
	AreaNumberValid bool `json:"area_number_valid"`
	GroupNumberValid bool `json:"group_number_valid"`
