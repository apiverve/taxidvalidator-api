...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/taxidvalidator',
        'Source': 'https://github.com/apiverve/taxidvalidator-api',
        'Bug Tracker': 'https://github.com/apiverve/taxidvalidator-api/issues'
    },
    classifiers=[
